    class JobViewerApp {
      ...
      initUI() {
        ...
        this.elements.btnAddJob = document.getElementById('btnAddJob');
        this.elements.btnDeleteJob = document.getElementById('btnDeleteJob');
        ...
        this.elements.addedJobList = document.getElementById('addedJobList');
        this.updateFonts();
      }
    ...
    deleteCurrentJob() {
        ...
        const removedJob = this.filteredData.splice(this.currentIndex, 1)[0];
        this.jobData = this.jobData.filter(j => j !== removedJob);
        this.updateAddedJobList();
        this.log("🗑️ Deleted current job.");
    ...
    exportJson() {
    const dataStr = JSON.stringify(this.jobData, null, 2);
